...
import 'package:health_track/services/user_model.dart';
...
class AuthenticationService {
  ...
  Future<void> addUserToDB(
      {String uid, String email, DateTime timestamp}) async {
    userModel = UserModel(uid: uid, email: email, timestamp: timestamp);
